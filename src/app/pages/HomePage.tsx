...
export function HomePage() {
  const feactureProducts = products.slice(0, 8);
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-6">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-violet-500 rounded-lg p-8 text-white">
      ...
      <section className="mb-12 mt-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-4">
          {categorias.map((categoria) => (
            <Link
              key={categoria.id}
              to={`/productos?categorias=${categoria.id}`}
      ...
      <section className="mb-12">
        <div className="flex items-center justify-between mb-6">
          ...
          <Link
            ...
            className="text-blue-600 hover:text-blue-700 flex items-center gap-1"
          >
            Ver todo lo Destacado
            <ChevronRight className="w-5 h-5 mt-0.5" />
          </Link>
        </div>

        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols gap-6">
